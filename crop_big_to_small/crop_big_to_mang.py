...
if __name__=="__main__":
    use_demo=True
    if use_demo:
        image_path='./data/JPEGImages/test.jpg'
        ann_path = './data/Annotations/test.xml'
        slice_voc_dir='./data/Annotations-output/'
        outdir = './data/JPEGImages-output/'
        ...
        raw_images_dir='./data/JPEGImages/'#这里的JPEGImages就是原始的图片,建议建立一个原始图片的软连接到这里(或把所有图片复制到voc/JPEGImages下面)
        raw_ann_dir='./data/Annotations/'#上一步convert_
        slice_voc_dir = './data/Annotations-output/'#切出来的标签也保存为voc格式
        outdir = './data/JPEGImages-output/'
