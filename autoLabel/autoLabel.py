...
class Detector():
    ...
    def client(self):
        ...
        def window():
            self.root_window = Tk()
            self.root_window.title("autoLable-数据自动标注工具")
            ...
            btn_2 = Button(self.root_window, text='选择要保存的xml文件夹(.xml)', command=test02,
                           height=0)
            btn_2.place(x=169, y=100, anchor='w')
            text = judge(self.outdir)
            text_label = Label(self.root_window, text=text)
            text_label.place(x=160, y=130, anchor='w')
            btn_3 = Button(self.root_window, text='选择配置文件(.yaml)', command=test03,
                           height=0)
            ...
            btn_4 = Button(self.root_window, text='选择预训练的模型(.pt)', command=test04,
                           height=0)
            ...
            btn_5 = Button(self.root_window, text='选择需要自动标注的类别文件(.txt)', command=test05,
                           height=0)
