...
# 建立cg数据的文件夹
new_dataset_train = '../datasets/data/train/images/'
new_dataset_test = '../datasets/data/test/images/'
new_dataset_valid = '../datasets/data/valid/images/'

new_dataset_trainl = '../datasets/data/train/labels/'
new_dataset_testl = '../datasets/data/test/labels/'
new_dataset_validl = '../datasets/data/valid/labels/'
...
# cg移动
fimg = '../datasets/JPEGImages/'
flable = '../datasets/worktxt/'
